...
var vertices = [
    //          x     y      z
        vec4( -1.5, -0.25,  0.75, 1.0 ),//front,bottom,left
        vec4( -1.5,  0.25,  0.75, 1.0 ),//front,top,left
        vec4( 1.5,  0.25,  0.75, 1.0 ),//front,top,right
        vec4( 1.5, -0.25,  0.75, 1.0 ),//front,bottom,right
        vec4( -1.5, -0.25, -0.75, 1.0 ),//back,bottom,left
        vec4( -1.5,  0.25, -0.75, 1.0 ),//back,top,left
        vec4( 1.5,  0.25, -0.75, 1.0 ),//back,top,right
        vec4( 1.5, -0.25, -0.75, 1.0 )//back,bottom,right
    ];
